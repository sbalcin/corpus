package com.domain.corpus.exception;

import com.domain.corpus.payload.ExceptionResponse;
...
public class RestControllerExceptionHandler {
    ...
    @ResponseBody
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<?> resolveException(DataIntegrityViolationException ex){
