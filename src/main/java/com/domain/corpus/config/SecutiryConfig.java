package com.domain.corpus.config;

import com.domain.corpus.repository.UserRepository;
import com.domain.corpus.security.JwtAuthenticationEntryPoint;
import com.domain.corpus.security.JwtAuthenticationFilter;
import com.domain.corpus.service.CustomUserDetailsService;
...
public class SecutiryConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/users/checkUsernameAvailability", "/api/users/checkEmailAvailability").permitAll()
